...
async def record_audio(
    duration: int = Query(5, description="Duration of recording in seconds"),
    fs: int = Query(16000, description="Sample rate (Hz)"),
    ...
    try:
        ...
        filename = f"recorded_audio_{unique_id}.wav"
